...
DiscoveryProb = 0.25; % Probability of discover eggs
ScaleFactor = 1; % Step size scale factor
...
MaxStagIterations   = 0.2*MaxIterations;
StepTolerance       = 1e-16;
...
% - Distribute the initial population uniformly along sDiscoveryProbce
...
%% Main proceduce: Cuckoo Search Optimisation Algorithm (SSOA)
